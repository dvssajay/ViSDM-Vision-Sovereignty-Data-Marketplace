...
def evaluate(
    ...
    torch.save(net.state_dict(),f"./Flmodels25/server_round_{server_round}.pth")
    print(f"Server-side evaluation loss testset {l} / accuracy testset {a}")
    print(f"Server-side evaluation loss {loss} / accuracy {accuracy}")
    loss_history["val"].append(accuracy)
    loss_history["test"].append(a)
...
with open('./Flmodels25/plot.csv', 'w') as f:
    writer = csv.writer(f)
